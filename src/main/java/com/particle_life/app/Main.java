...
public class Main extends App{
  ...
  private void buildGui() {
    ...
    if(showGui.get()) {
      if(ImGui.begin("App",showGui,ImGuiWindowFlags.None|ImGuiWindowFlags.NoResize|ImGuiWindowFlags.NoFocusOnAppearing|ImGuiWindowFlags.NoBringToFrontOnFocus|ImGuiWindowFlags.NoTitleBar|ImGuiWindowFlags.MenuBar)) {
    ...
    if(showSettings.get()&&showGui.get()) {
      if(ImGui.begin("Settings",showSettings,ImGuiWindowFlags.None|ImGuiWindowFlags.NoResize|ImGuiWindowFlags.NoFocusOnAppearing)) {
        {
