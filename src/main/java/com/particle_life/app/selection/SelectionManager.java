...
public class SelectionManager<T>{
  ...
  /**
   * Change the active element by going the given number of steps forward. This is done in a
   * circular manner, meaning that stepping over the end of the selection results in coming out at
   * the beginning, and vice-versa.
   *
   * @param step how many steps to move from the current active element (positive: forward,
   *             negative: backward)
   */
  ...
  /**
   * Returns the index of the first element whose name is equal to the given string. If no such
   * element can be found, -1 is returned.
   *
